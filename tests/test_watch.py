...
def test_apply_tracks_cell_stage_and_tool_calls():
    ...
    _feed(
        ...
        [
            ...
            {"event": "agent_stage", "cell": "NVDA", "decision_date": "2026-01-02", "stage": "reasoning", "round": 1, "text": "thinking"},
            {"event": "agent_tool_call", "cell": "NVDA", "decision_date": "2026-01-02", "tool": "fintel__get_prices"},
            {"event": "agent_tool_result", "cell": "NVDA", "decision_date": "2026-01-02", "tool": "fintel__get_prices", "ok": True},
            {"event": "agent_tool_call", "cell": "NVDA", "decision_date": "2026-01-02", "tool": "fintel__get_news"},
            {"event": "agent_tool_result", "cell": "NVDA", "decision_date": "2026-01-02", "tool": "fintel__get_news", "ok": False},
            {"event": "cell_done", "cell": "NVDA", "decision_date": "2026-01-02", "outcome": "ok", "health": "ok", "n_reads": 2, "elapsed_ms": 10},
...
def test_render_produces_a_frame_with_run_and_cell():
    ...
    _feed(
        ...
        [
            ...
            {"event": "cell_start", "cell": "NVDA", "decision_date": "2026-01-02"},
            {"event": "agent_tool_call", "cell": "NVDA", "decision_date": "2026-01-02", "tool": "fintel__get_prices"},
            {"event": "cell_done", "cell": "NVDA", "decision_date": "2026-01-02", "outcome": "ok", "health": "ok", "n_reads": 1, "elapsed_ms": 5},
            {"event": "run_done", "status": "ok"},
        ],
    )
    import time
...
def test_apply_disambiguates_same_symbol_across_dates():
    ...
    _feed(
        ...
        [
            ...
            {"event": "agent_stage", "cell": "NVDA", "decision_date": "2026-04-01", "stage": "reasoning", "round": 1, "text": "apr thinking"},
            {"event": "run_done", "status": "ok"},
        ],
    )
