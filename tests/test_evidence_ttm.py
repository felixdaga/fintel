...
def test_growth_block_refuses_gapped_ttm_sum():
    ...
    panel = [
        _q("2025-12-27", "Q1", revenue=143.0, net_income=42.0, operating_income=50.0,
           gross_profit=69.0, operating_cash_flow=54.0, free_cash_flow=None,
           eps_diluted=2.84),
        _q("2025-06-28", "Q3", revenue=94.0, net_income=23.0, operating_income=28.0,
           gross_profit=44.0, operating_cash_flow=28.0, eps_diluted=1.5),
        _q("2025-03-29", "Q2", revenue=95.0, net_income=24.0, operating_income=29.0,
           gross_profit=45.0, operating_cash_flow=24.0, eps_diluted=1.6),
        _q("2024-12-28", "Q1", revenue=124.0, net_income=36.0, operating_income=43.0,
           gross_profit=58.0, operating_cash_flow=30.0, eps_diluted=2.4),
    ]
...
def test_growth_block_emits_contiguous_ttm():
    panel = [
        _q("2025-12-27", "Q1", revenue=100.0, net_income=10.0, operating_income=12.0,
           gross_profit=40.0, operating_cash_flow=15.0, free_cash_flow=11.0,
           eps_diluted=1.0),
        _q("2025-09-27", "Q4", revenue=90.0, net_income=9.0, operating_income=11.0,
           gross_profit=36.0, operating_cash_flow=14.0, free_cash_flow=10.0,
           eps_diluted=0.9),
        _q("2025-06-28", "Q3", revenue=80.0, net_income=8.0, operating_income=10.0,
           gross_profit=32.0, operating_cash_flow=13.0, free_cash_flow=9.0,
           eps_diluted=0.8),
        _q("2025-03-29", "Q2", revenue=70.0, net_income=7.0, operating_income=9.0,
           gross_profit=28.0, operating_cash_flow=12.0, free_cash_flow=8.0,
           eps_diluted=0.7),
    ]
    text = _evidence()._growth_block(panel)
